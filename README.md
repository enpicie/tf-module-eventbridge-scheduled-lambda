...
The caller is responsible for creating and passing in the Lambda execution role. This keeps permission definitions close to the application that needs them.
...
module "my_scheduled_lambda" {
  ...
  iam_role_arn        = aws_iam_role.my_lambda_role.arn
...
| `iam_role_arn` | ARN of the IAM execution role for the Lambda function | `string` | — | yes |
